...
@Entity
@SequenceGenerator(sequenceName="conselho_seq", name="conselho_id", allocationSize=1)
public class Conselho extends AbstractEntity{
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "conselho_id")
    private Long id;
    private String nome;
