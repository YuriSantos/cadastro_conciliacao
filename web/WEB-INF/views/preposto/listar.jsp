    ...
    <div class="col-xs-12">
        <div class="box box-primary">
            ...
            <table id="tabela" class="table table-striped">
                ...
                <tbody>
                <c:forEach items="${prepostos}" var="preposto">
                    <tr>
                        <td>${preposto.nome}</td>
                        <td class="col-xs-1">
                            <a href="${preposto.id}/atualizar" class="fa fa-2x fa-edit"></a>

                        </td>
                        <td class="col-xs-1">
                            <a href="${preposto.id}/deletar" onclick="return confirm('Deseja excluir o registro?')" class="fa fa-2x fa-trash"></a>
